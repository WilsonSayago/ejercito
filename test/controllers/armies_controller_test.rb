...
class ArmiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create army" do
    assert_difference('Army.count') do
      post armies_url, params: { army: { civilization_id: @army.civilization_id, saldo: @army.saldo } }
    end
  ...
  test "should update army" do
    patch army_url(@army), params: { army: { civilization_id: @army.civilization_id, saldo: @army.saldo } }
